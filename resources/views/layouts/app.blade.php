...
<head>
    ...
    <title>OBAÑA | Dashboard v.3</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <img alt="image" class="rounded-circle" width="50px" src="https://avatars.githubusercontent.com/u/147499535?v=4"/>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="block m-t-xs font-bold">Alcel Marie Obaña</span>
                ...
                <li class="active">
                        ...
                        <li><a href="{{ url ('movies') }}"><i class="fas fa-film"></i>Movies</a></li>
                        <li><a href="{{ url ('book') }}"><i class="fas fa-book"></i>Books</a></li>
                        <li><a href="{{ url ('page4') }}"><i class="fas fa-folder"></i>Page 4</a></li>
                        <li><a href="{{ url ('page5') }}"><i class="fas fa-folder"></i>Page 5 </a></li>
